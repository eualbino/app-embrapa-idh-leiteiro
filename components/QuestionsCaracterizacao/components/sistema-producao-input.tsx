  ...
  <View style={stylesQuestions.containerResponses}>
    <View>
      <Text style={stylesQuestions.questionText}>
        ...
        <Text>
          Qual é o Sistema de Produção empregado pela propriedade?
        </Text>
      </Text>
    </View>
    ...
    <View style={stylesQuestions.optionMainContainer}>
      ...
      >
        ...
        <View style={{ flex: 1, marginRight: 1 }}>
          <Text style={[stylesQuestions.questionsResponseText]}>
            Confinado (volumoso e concentrado no cocho) sem acesso a
            pastagem
          </Text>
        </View>
      </TouchableOpacity>
    ...
    <View style={stylesQuestions.optionMainContainer}>
      ...
      >
        ...
        <View style={{ flex: 1, marginRight: 1 }}>
          <Text style={[stylesQuestions.questionsResponseText]}>
            Confinado para vacas em lactação e pasto (com ou sem
            suplementação) para demais categorias
          </Text>
        </View>
      </TouchableOpacity>
    </View>
